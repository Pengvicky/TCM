...
#define CC_ECC_Parameters (CC_NO && ALG_ECC)
...
#define CC_NV_UndefineSpaceSpecial CC_NO
#define CC_NV_Write CC_YES
#define CC_NV_WriteLock CC_YES
#define CC_ObjectChangeAuth CC_YES
#define CC_PCR_Allocate CC_NO
#define CC_PCR_Event CC_NO
...
#define CC_PolicyAuthorize CC_NO
#define CC_PolicyAuthorizeNV CC_NO
#define CC_PolicyCapability CC_NO
#define CC_PolicyCommandCode CC_YES
#define CC_PolicyCounterTimer CC_NO
#define CC_PolicyCpHash CC_YES
#define CC_PolicyDuplicationSelect CC_NO
#define CC_PolicyGetDigest CC_YES
#define CC_PolicyLocality CC_NO
#define CC_PolicyNV CC_NO
#define CC_PolicyNameHash CC_NO
#define CC_PolicyNvWritten CC_NO
#define CC_PolicyOR CC_YES
#define CC_PolicyPCR CC_YES
#define CC_PolicyPassword CC_YES
#define CC_PolicyParameters CC_NO
...
#define CC_PolicyTemplate CC_NO
#define CC_PolicyTicket CC_YES
#define CC_Policy_AC_SendSelect CC_NO
#define CC_Quote CC_YES
#define CC_RSA_Decrypt (CC_NO && ALG_RSA)
#define CC_RSA_Encrypt (CC_NO && ALG_RSA)
#define CC_ReadClock CC_NO
...
#define CC_NV_DefineSpace2 CC_NO
#define CC_NV_ReadPublic2 CC_NO
