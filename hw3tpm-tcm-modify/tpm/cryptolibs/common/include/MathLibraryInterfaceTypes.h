...
#define CRYPT_INT_VAR(varname, bits)          \
    CRYPT_INT_BUF(ci_##varname##_buf_t, bits) \
    varname##_buf;                            \
...
#define CRYPT_INT_INITIALIZED(varname, bits, initializer)            \
    CRYPT_INT_BUF(cibuf##varname, bits)                              \
    varname##_buf;                                                   \
...
#define CRYPT_INT_WORD_INITIALIZED(varname, initializer)                   \
    CRYPT_INT_BUF(cibuf##varname, RADIX_BITS)                              \
    varname##_buf;                                                         \
...
#define CRYPT_CURVE_INITIALIZED(varname, initializer) \
    CRYPT_CURVE_BUF(cv##varname, MAX_ECC_KEY_BITS)    \
    varname##_buf;                                    \
...
#define CRYPT_POINT_VAR(varname)                            \
    CRYPT_POINT_BUF(cp_##varname##_buf_t, MAX_ECC_KEY_BITS) \
    varname##_buf;                                          \
    Crypt_Point *varname =                                  \
