...
TPM_INLINE bigConst
BnCurveGetPrime(const TPMBN_ECC_CURVE_CONSTANTS *C)
{
    return C->prime;
}
...
#define BIG_ENDIAN_BYTES_TO_UINT64(a, b, c, d, e, f, g, h) \
    (((UINT64)(a) << 56) + ((UINT64)(b) << 48) + ((UINT64)(c) << 40) + ((UINT64)(d) << 32) + ((UINT64)(e) << 24) + ((UINT64)(f) << 16) + ((UINT64)(g) << 8) + ((UINT64)(h)))
...
#define B8_TO_BN(a, b, c, d, e, f, g, h)                                               \
    ((((((((((((((((UINT64)a) << 8) | (UINT64)b) << 8) | (UINT64)c) << 8) | (UINT64)d) \
            << 8) |                                                                    \
           (UINT64)e)                                                                  \
          << 8) |                                                                      \
         (UINT64)f)                                                                    \
