    ...
    TPMI_DH_OBJECT *target, BYTE **buffer, INT32 *size, BOOL flag)
{
    ...
    if ((result == TPM_RC_SUCCESS) && ((*target != TPM_RH_NULL) || !flag) && ((*target < TRANSIENT_FIRST) || (*target > TRANSIENT_LAST)) && ((*target < PERSISTENT_FIRST) || (*target > PERSISTENT_LAST)))
        result = TPM_RC_VALUE;
    return result;
}
#if !USE_MARSHALING_DEFINES
...
TPMI_DH_PERSISTENT_Unmarshal(TPMI_DH_PERSISTENT *target, BYTE **buffer, INT32 *size)
{
    TPM_RC result;
    result = TPM_HANDLE_Unmarshal((TPM_HANDLE *)target, buffer, size);
    if ((result == TPM_RC_SUCCESS) && ((*target < PERSISTENT_FIRST) || (*target > PERSISTENT_LAST)))
        result = TPM_RC_VALUE;
    return result;
}
#if !USE_MARSHALING_DEFINES
    ...
    TPMI_DH_ENTITY *target, BYTE **buffer, INT32 *size, BOOL flag)
{
    ...
    if (result == TPM_RC_SUCCESS)
    {
        ...
        case TPM_RH_LOCKOUT:
            break;
        default:
            if (((*target != TPM_RH_NULL) || !flag) && ((*target < TRANSIENT_FIRST) || (*target > TRANSIENT_LAST)) && ((*target < PERSISTENT_FIRST) || (*target > PERSISTENT_LAST)) && ((*target < NV_INDEX_FIRST) || (*target > NV_INDEX_LAST)) && (*target > PCR_LAST) && ((*target < TPM_RH_AUTH_00) || (*target > TPM_RH_AUTH_FF)))
                result = TPM_RC_VALUE;
            break;
        }
    }
...
TPMI_DH_PCR_Unmarshal(TPMI_DH_PCR *target, BYTE **buffer, INT32 *size, BOOL flag)
{
    TPM_RC result;
    result = TPM_HANDLE_Unmarshal((TPM_HANDLE *)target, buffer, size);
    if ((result == TPM_RC_SUCCESS) && ((*target != TPM_RH_NULL) || !flag) && (*target > PCR_LAST))
        result = TPM_RC_VALUE;
    return result;
}
    ...
    TPMI_SH_AUTH_SESSION *target, BYTE **buffer, INT32 *size, BOOL flag)
{
    TPM_RC result;
    result = TPM_HANDLE_Unmarshal((TPM_HANDLE *)target, buffer, size);
    if ((result == TPM_RC_SUCCESS) && ((*target != TPM_RS_PW) || !flag) && ((*target < HMAC_SESSION_FIRST) || (*target > HMAC_SESSION_LAST)) && ((*target < POLICY_SESSION_FIRST) || (*target > POLICY_SESSION_LAST)))
        result = TPM_RC_VALUE;
    return result;
}
#if !USE_MARSHALING_DEFINES
...
TPMI_SH_HMAC_Unmarshal(TPMI_SH_HMAC *target, BYTE **buffer, INT32 *size)
{
    TPM_RC result;
    result = TPM_HANDLE_Unmarshal((TPM_HANDLE *)target, buffer, size);
    if ((result == TPM_RC_SUCCESS) && ((*target < HMAC_SESSION_FIRST) || (*target > HMAC_SESSION_LAST)))
        result = TPM_RC_VALUE;
    return result;
}
#if !USE_MARSHALING_DEFINES
...
TPMI_SH_POLICY_Unmarshal(TPMI_SH_POLICY *target, BYTE **buffer, INT32 *size)
{
    TPM_RC result;
    result = TPM_HANDLE_Unmarshal((TPM_HANDLE *)target, buffer, size);
    if ((result == TPM_RC_SUCCESS) && ((*target < POLICY_SESSION_FIRST) || (*target > POLICY_SESSION_LAST)))
        result = TPM_RC_VALUE;
    return result;
}
#if !USE_MARSHALING_DEFINES
...
TPMI_DH_CONTEXT_Unmarshal(TPMI_DH_CONTEXT *target, BYTE **buffer, INT32 *size)
{
    TPM_RC result;
    result = TPM_HANDLE_Unmarshal((TPM_HANDLE *)target, buffer, size);
    if ((result == TPM_RC_SUCCESS) && ((*target < HMAC_SESSION_FIRST) || (*target > HMAC_SESSION_LAST)) && ((*target < POLICY_SESSION_FIRST) || (*target > POLICY_SESSION_LAST)) && ((*target < TRANSIENT_FIRST) || (*target > TRANSIENT_LAST)))
        result = TPM_RC_VALUE;
    return result;
}
#if !USE_MARSHALING_DEFINES
...
TPMI_DH_SAVED_Unmarshal(TPMI_DH_SAVED *target, BYTE **buffer, INT32 *size)
{
    ...
    if (result == TPM_RC_SUCCESS)
    {
        ...
        case 0x80000002:
            break;
        default:
            if (((*target < HMAC_SESSION_FIRST) || (*target > HMAC_SESSION_LAST)) && ((*target < POLICY_SESSION_FIRST) || (*target > POLICY_SESSION_LAST)))
                result = TPM_RC_VALUE;
            break;
        }
    }
...
TPMI_RH_HIERARCHY_Unmarshal(TPMI_RH_HIERARCHY *target, BYTE **buffer, INT32 *size)
{
    ...
    if (result == TPM_RC_SUCCESS)
    {
        ...
        case TPM_RH_FW_PLATFORM:
            break;
        default:
            if ((*target != TPM_RH_NULL) && (*target != TPM_RH_FW_NULL) && ((*target < SVN_NULL_FIRST) || (*target > SVN_NULL_LAST)) && ((*target < SVN_OWNER_FIRST) || (*target > SVN_OWNER_LAST)) && ((*target < SVN_ENDORSEMENT_FIRST) || (*target > SVN_ENDORSEMENT_LAST)) && ((*target < SVN_PLATFORM_FIRST) || (*target > SVN_PLATFORM_LAST)))
                result = TPM_RC_VALUE;
            break;
        }
    }
...
TPMI_RH_NV_INDEX_Unmarshal(TPMI_RH_NV_INDEX *target, BYTE **buffer, INT32 *size)
{
    TPM_RC result;
    result = TPM_HANDLE_Unmarshal((TPM_HANDLE *)target, buffer, size);
    if ((result == TPM_RC_SUCCESS) && ((*target < NV_INDEX_FIRST) || (*target > NV_INDEX_LAST)) && ((*target < EXTERNAL_NV_FIRST) || (*target > EXTERNAL_NV_LAST)) && ((*target < PERMANENT_NV_FIRST) || (*target > PERMANENT_NV_LAST)))
        result = TPM_RC_VALUE;
    return result;
}
#if !USE_MARSHALING_DEFINES
    ...
    TPMI_RH_NV_DEFINED_INDEX *target, BYTE **buffer, INT32 *size)
{
    TPM_RC result;
    result = TPM_HANDLE_Unmarshal((TPM_HANDLE *)target, buffer, size);
    if ((result == TPM_RC_SUCCESS) && ((*target < NV_INDEX_FIRST) || (*target > NV_INDEX_LAST)) && ((*target < EXTERNAL_NV_FIRST) || (*target > EXTERNAL_NV_LAST)))
        result = TPM_RC_VALUE;
    return result;
}
    ...
    TPMI_RH_NV_LEGACY_INDEX *target, BYTE **buffer, INT32 *size)
{
    TPM_RC result;
    result = TPM_HANDLE_Unmarshal((TPM_HANDLE *)target, buffer, size);
    if ((result == TPM_RC_SUCCESS) && ((*target < NV_INDEX_FIRST) || (*target > NV_INDEX_LAST)))
        result = TPM_RC_VALUE;
    return result;
}
#if !USE_MARSHALING_DEFINES
    ...
    TPMI_RH_NV_EXP_INDEX *target, BYTE **buffer, INT32 *size)
{
    TPM_RC result;
    result = TPM_HANDLE_Unmarshal((TPM_HANDLE *)target, buffer, size);
    if ((result == TPM_RC_SUCCESS) && ((*target < EXTERNAL_NV_FIRST) || (*target > EXTERNAL_NV_LAST)))
        result = TPM_RC_VALUE;
    return result;
}
#if !USE_MARSHALING_DEFINES
...
TPMI_RH_ACT_Unmarshal(TPMI_RH_ACT *target, BYTE **buffer, INT32 *size)
{
    TPM_RC result;
    result = TPM_HANDLE_Unmarshal((TPM_HANDLE *)target, buffer, size);
    if ((result == TPM_RC_SUCCESS) && ((*target < TPM_RH_ACT_0) || (*target > TPM_RH_ACT_F)))
        result = TPM_RC_VALUE;
    return result;
}
#if !USE_MARSHALING_DEFINES
    ...
    TPMS_ALGORITHM_DESCRIPTION *source, BYTE **buffer, INT32 *size)
{
    UINT16 result = 0;
    result =
        (UINT16)(result + TPM_ALG_ID_Marshal((TPM_ALG_ID *)&(source->alg), buffer, size));
    result = (UINT16)(result + TPMA_ALGORITHM_Marshal(
...
TPMT_HA_Marshal(TPMT_HA *source, BYTE **buffer, INT32 *size)
{
    ...
    result = (UINT16)(result + TPMU_HA_Marshal((TPMU_HA *)&(source->digest),
                                               buffer,
                                               size,
...
TPM2B_NAME_Marshal(TPM2B_NAME *source, BYTE **buffer, INT32 *size)
{
    ...
    if (source->t.size == 0)
        return result;
    result =
        (UINT16)(result + BYTE_Array_Marshal(
...
TPMS_PCR_SELECT_Unmarshal(TPMS_PCR_SELECT *target, BYTE **buffer, INT32 *size)
{
    ...
    if ((result == TPM_RC_SUCCESS) && ((target->sizeofSelect < PCR_SELECT_MIN) || (target->sizeofSelect > PCR_SELECT_MAX)))
        result = TPM_RC_VALUE;
    if (result == TPM_RC_SUCCESS)
        result = BYTE_Array_Unmarshal(
...
TPMS_PCR_SELECT_Marshal(TPMS_PCR_SELECT *source, BYTE **buffer, INT32 *size)
{
    ...
    result = (UINT16)(result + BYTE_Array_Marshal((BYTE *)&(source->pcrSelect),
                                                  buffer,
                                                  size,
...
TPMT_TK_CREATION_Marshal(TPMT_TK_CREATION *source, BYTE **buffer, INT32 *size)
{
    ...
    result = (UINT16)(result + TPMI_RH_HIERARCHY_Marshal(
...
TPMT_TK_AUTH_Unmarshal(TPMT_TK_AUTH *target, BYTE **buffer, INT32 *size)
{
    TPM_RC result;
    result = TPM_ST_Unmarshal((TPM_ST *)&(target->tag), buffer, size);
    if ((result == TPM_RC_SUCCESS) && (target->tag != TPM_ST_AUTH_SIGNED) && (target->tag != TPM_ST_AUTH_SECRET))
        result = TPM_RC_TAG;
    if (result == TPM_RC_SUCCESS)
        result = TPMI_RH_HIERARCHY_Unmarshal(
            (TPMI_RH_HIERARCHY *)&(target->hierarchy), buffer, size);
    ...
    TPMS_TAGGED_PCR_SELECT *source, BYTE **buffer, INT32 *size)
{
    UINT16 result = 0;
    result =
        (UINT16)(result + TPM_PT_PCR_Marshal((TPM_PT_PCR *)&(source->tag), buffer, size));
    result = (UINT16)(result + UINT8_Marshal((UINT8 *)&(source->sizeofSelect), buffer, size));
    result = (UINT16)(result + BYTE_Array_Marshal((BYTE *)&(source->pcrSelect),
                                                  buffer,
                                                  size,
...
TPMS_TAGGED_POLICY_Marshal(TPMS_TAGGED_POLICY *source, BYTE **buffer, INT32 *size)
{
    UINT16 result = 0;
    result =
        (UINT16)(result + TPM_HANDLE_Marshal((TPM_HANDLE *)&(source->handle), buffer, size));
    result =
        (UINT16)(result + TPMT_HA_Marshal((TPMT_HA *)&(source->policyHash), buffer, size));
    return result;
}
...
TPMS_ACT_DATA_Marshal(TPMS_ACT_DATA *source, BYTE **buffer, INT32 *size)
{
    ...
    result =
        (UINT16)(result + TPMA_ACT_Marshal((TPMA_ACT *)&(source->attributes), buffer, size));
    return result;
}
...
TPML_CC_Marshal(TPML_CC *source, BYTE **buffer, INT32 *size)
{
    ...
    result = (UINT16)(result + TPM_CC_Array_Marshal((TPM_CC *)&(source->commandCodes),
                                                    buffer,
                                                    size,
                                                    (INT32)source->count));
    return result;
...
TPML_CCA_Marshal(TPML_CCA *source, BYTE **buffer, INT32 *size)
{
    ...
    result =
        (UINT16)(result + UINT32_Marshal((UINT32 *)&(source->count), buffer, size));
    result = (UINT16)(result + TPMA_CC_Array_Marshal((TPMA_CC *)&(source->commandAttributes),
                                                     buffer,
                                                     size,
                                                     (INT32)source->count));
    return result;
...
TPML_ALG_Marshal(TPML_ALG *source, BYTE **buffer, INT32 *size)
{
    ...
    result =
        (UINT16)(result + UINT32_Marshal((UINT32 *)&(source->count), buffer, size));
    result = (UINT16)(result + TPM_ALG_ID_Array_Marshal((TPM_ALG_ID *)&(source->algorithms),
                                                        buffer,
                                                        size,
                                                        (INT32)source->count));
    return result;
...
TPML_HANDLE_Marshal(TPML_HANDLE *source, BYTE **buffer, INT32 *size)
{
    ...
    result =
        (UINT16)(result + UINT32_Marshal((UINT32 *)&(source->count), buffer, size));
    result = (UINT16)(result + TPM_HANDLE_Array_Marshal((TPM_HANDLE *)&(source->handle),
                                                        buffer,
                                                        size,
                                                        (INT32)source->count));
    return result;
...
TPML_DIGEST_Marshal(TPML_DIGEST *source, BYTE **buffer, INT32 *size)
{
    ...
    result =
        (UINT16)(result + UINT32_Marshal((UINT32 *)&(source->count), buffer, size));
    result = (UINT16)(result + TPM2B_DIGEST_Array_Marshal((TPM2B_DIGEST *)&(source->digests),
                                                          buffer,
                                                          size,
                                                          (INT32)source->count));
    return result;
...
TPML_DIGEST_VALUES_Marshal(TPML_DIGEST_VALUES *source, BYTE **buffer, INT32 *size)
{
    ...
    result =
        (UINT16)(result + UINT32_Marshal((UINT32 *)&(source->count), buffer, size));
    result = (UINT16)(result + TPMT_HA_Array_Marshal((TPMT_HA *)&(source->digests),
                                                     buffer,
                                                     size,
                                                     (INT32)source->count));
    return result;
...
TPML_PCR_SELECTION_Marshal(TPML_PCR_SELECTION *source, BYTE **buffer, INT32 *size)
{
    ...
    result =
        (UINT16)(result + UINT32_Marshal((UINT32 *)&(source->count), buffer, size));
    result = (UINT16)(result + TPMS_PCR_SELECTION_Array_Marshal(
...
TPML_ALG_PROPERTY_Marshal(TPML_ALG_PROPERTY *source, BYTE **buffer, INT32 *size)
{
    ...
    result =
        (UINT16)(result + UINT32_Marshal((UINT32 *)&(source->count), buffer, size));
    result = (UINT16)(result + TPMS_ALG_PROPERTY_Array_Marshal(
    ...
    TPML_TAGGED_TPM_PROPERTY *source, BYTE **buffer, INT32 *size)
{
    ...
    result =
        (UINT16)(result + UINT32_Marshal((UINT32 *)&(source->count), buffer, size));
    result = (UINT16)(result + TPMS_TAGGED_PROPERTY_Array_Marshal(
    ...
    TPML_TAGGED_PCR_PROPERTY *source, BYTE **buffer, INT32 *size)
{
    ...
    result =
        (UINT16)(result + UINT32_Marshal((UINT32 *)&(source->count), buffer, size));
    result = (UINT16)(result + TPMS_TAGGED_PCR_SELECT_Array_Marshal(
...
TPML_ECC_CURVE_Marshal(TPML_ECC_CURVE *source, BYTE **buffer, INT32 *size)
{
    ...
    result =
        (UINT16)(result + UINT32_Marshal((UINT32 *)&(source->count), buffer, size));
    result =
        (UINT16)(result + TPM_ECC_CURVE_Array_Marshal((TPM_ECC_CURVE *)&(source->eccCurves),
                                                      buffer,
                                                      size,
                                                      (INT32)source->count));
    return result;
...
TPML_TAGGED_POLICY_Marshal(TPML_TAGGED_POLICY *source, BYTE **buffer, INT32 *size)
{
    ...
    result =
        (UINT16)(result + UINT32_Marshal((UINT32 *)&(source->count), buffer, size));
    result = (UINT16)(result + TPMS_TAGGED_POLICY_Array_Marshal(
...
TPML_ACT_DATA_Marshal(TPML_ACT_DATA *source, BYTE **buffer, INT32 *size)
{
    ...
    result =
        (UINT16)(result + UINT32_Marshal((UINT32 *)&(source->count), buffer, size));
    result =
        (UINT16)(result + TPMS_ACT_DATA_Array_Marshal((TPMS_ACT_DATA *)&(source->actData),
                                                      buffer,
                                                      size,
                                                      (INT32)source->count));
    return result;
...
TPML_VENDOR_PROPERTY_Marshal(TPML_VENDOR_PROPERTY *source, BYTE **buffer, INT32 *size)
{
    ...
    result =
        (UINT16)(result + UINT32_Marshal((UINT32 *)&(source->count), buffer, size));
    result = (UINT16)(result + TPM2B_VENDOR_PROPERTY_Array_Marshal(
...
TPMS_CAPABILITY_DATA_Marshal(TPMS_CAPABILITY_DATA *source, BYTE **buffer, INT32 *size)
{
    UINT16 result = 0;
    result =
        (UINT16)(result + TPM_CAP_Marshal((TPM_CAP *)&(source->capability), buffer, size));
    result = (UINT16)(result + TPMU_CAPABILITIES_Marshal((TPMU_CAPABILITIES *)&(source->data),
                                                         buffer,
                                                         size,
...
TPMS_CLOCK_INFO_Marshal(TPMS_CLOCK_INFO *source, BYTE **buffer, INT32 *size)
{
    ...
    result =
        (UINT16)(result + UINT32_Marshal((UINT32 *)&(source->restartCount), buffer, size));
    result =
        (UINT16)(result + TPMI_YES_NO_Marshal((TPMI_YES_NO *)&(source->safe), buffer, size));
    return result;
}
...
TPMS_TIME_INFO_Marshal(TPMS_TIME_INFO *source, BYTE **buffer, INT32 *size)
{
    ...
    result = (UINT16)(result + TPMS_CLOCK_INFO_Marshal(
...
{
    UINT16 result = 0;
    result = (UINT16)(result + TPMS_TIME_INFO_Marshal(
                                   (TPMS_TIME_INFO *)&(source->time), buffer, size));
    result =
        (UINT16)(result + UINT64_Marshal((UINT64 *)&(source->firmwareVersion), buffer, size));
    return result;
}
...
TPMS_CERTIFY_INFO_Marshal(TPMS_CERTIFY_INFO *source, BYTE **buffer, INT32 *size)
{
    UINT16 result = 0;
    result =
        (UINT16)(result + TPM2B_NAME_Marshal((TPM2B_NAME *)&(source->name), buffer, size));
    result = (UINT16)(result + TPM2B_NAME_Marshal(
...
{
    UINT16 result = 0;
    result = (UINT16)(result + TPML_PCR_SELECTION_Marshal(
    ...
    TPMS_COMMAND_AUDIT_INFO *source, BYTE **buffer, INT32 *size)
{
    UINT16 result = 0;
    result =
        (UINT16)(result + UINT64_Marshal((UINT64 *)&(source->auditCounter), buffer, size));
    result = (UINT16)(result + TPM_ALG_ID_Marshal(
...
{
    UINT16 result = 0;
    result = (UINT16)(result + TPMI_YES_NO_Marshal(
...
TPMS_NV_CERTIFY_INFO_Marshal(TPMS_NV_CERTIFY_INFO *source, BYTE **buffer, INT32 *size)
{
    ...
    result = (UINT16)(result + TPM2B_MAX_NV_BUFFER_Marshal(
...
{
    UINT16 result = 0;
    result = (UINT16)(result + TPM_CONSTANTS32_Marshal(
                                   (TPM_CONSTANTS32 *)&(source->magic), buffer, size));
    result = (UINT16)(result + TPMI_ST_ATTEST_Marshal(
                                   (TPMI_ST_ATTEST *)&(source->type), buffer, size));
    result = (UINT16)(result + TPM2B_NAME_Marshal(
                                   (TPM2B_NAME *)&(source->qualifiedSigner), buffer, size));
    result = (UINT16)(result + TPM2B_DATA_Marshal(
                                   (TPM2B_DATA *)&(source->extraData), buffer, size));
    result = (UINT16)(result + TPMS_CLOCK_INFO_Marshal(
                                   (TPMS_CLOCK_INFO *)&(source->clockInfo), buffer, size));
    result =
        (UINT16)(result + UINT64_Marshal((UINT64 *)&(source->firmwareVersion), buffer, size));
    result = (UINT16)(result + TPMU_ATTEST_Marshal((TPMU_ATTEST *)&(source->attested),
                                                   buffer,
                                                   size,
                                                   (UINT32)source->type));
    return result;
...
TPM2B_ATTEST_Marshal(TPM2B_ATTEST *source, BYTE **buffer, INT32 *size)
{
    ...
    if (source->t.size == 0)
        return result;
    result = (UINT16)(result + BYTE_Array_Marshal((BYTE *)&(source->t.attestationData),
                                                  buffer,
                                                  size,
                                                  (INT32)source->t.size));
    return result;
...
TPMS_AUTH_RESPONSE_Marshal(TPMS_AUTH_RESPONSE *source, BYTE **buffer, INT32 *size)
{
    UINT16 result = 0;
    result =
        (UINT16)(result + TPM2B_NONCE_Marshal((TPM2B_NONCE *)&(source->nonce), buffer, size));
    result = (UINT16)(result + TPMA_SESSION_Marshal(
                                   (TPMA_SESSION *)&(source->sessionAttributes), buffer, size));
    result =
        (UINT16)(result + TPM2B_AUTH_Marshal((TPM2B_AUTH *)&(source->hmac), buffer, size));
    return result;
}
...
{
    UINT16 result = 0;
    result = (UINT16)(result + TPMI_ALG_SYM_Marshal(
                                   (TPMI_ALG_SYM *)&(source->algorithm), buffer, size));
    result =
        (UINT16)(result + TPMU_SYM_KEY_BITS_Marshal((TPMU_SYM_KEY_BITS *)&(source->keyBits),
                                                    buffer,
                                                    size,
                                                    (UINT32)source->algorithm));
    result = (UINT16)(result + TPMU_SYM_MODE_Marshal((TPMU_SYM_MODE *)&(source->mode),
                                                     buffer,
                                                     size,
                                                     (UINT32)source->algorithm));
    return result;
...
{
    UINT16 result = 0;
    result = (UINT16)(result + TPMI_ALG_SYM_OBJECT_Marshal(
...
{
    UINT16 result = 0;
    result = (UINT16)(result + TPMT_SYM_DEF_OBJECT_Marshal(
...
TPMS_DERIVE_Marshal(TPMS_DERIVE *source, BYTE **buffer, INT32 *size)
{
    UINT16 result = 0;
    result =
        (UINT16)(result + TPM2B_LABEL_Marshal((TPM2B_LABEL *)&(source->label), buffer, size));
    result = (UINT16)(result + TPM2B_LABEL_Marshal(
...
TPMS_SCHEME_XOR_Marshal(TPMS_SCHEME_XOR *source, BYTE **buffer, INT32 *size)
{
    ...
    result = (UINT16)(result + TPMI_ALG_HASH_Marshal(
                                   (TPMI_ALG_HASH *)&(source->hashAlg), buffer, size));
    result =
        (UINT16)(result + TPMI_ALG_KDF_Marshal((TPMI_ALG_KDF *)&(source->kdf), buffer, size));
    return result;
}
    ...
    TPMT_KEYEDHASH_SCHEME *source, BYTE **buffer, INT32 *size)
{
    UINT16 result = 0;
    result =
        (UINT16)(result + TPMI_ALG_KEYEDHASH_SCHEME_Marshal(
                              (TPMI_ALG_KEYEDHASH_SCHEME *)&(source->scheme), buffer, size));
    result = (UINT16)(result + TPMU_SCHEME_KEYEDHASH_Marshal(
...
{
    UINT16 result = 0;
    result = (UINT16)(result + TPMI_ALG_SIG_SCHEME_Marshal(
                                   (TPMI_ALG_SIG_SCHEME *)&(source->scheme), buffer, size));
    result = (UINT16)(result + TPMU_SIG_SCHEME_Marshal((TPMU_SIG_SCHEME *)&(source->details),
                                                       buffer,
                                                       size,
                                                       (UINT32)source->scheme));
    return result;
...
{
    UINT16 result = 0;
    result = (UINT16)(result + TPMI_ALG_KDF_Marshal(
                                   (TPMI_ALG_KDF *)&(source->scheme), buffer, size));
    result = (UINT16)(result + TPMU_KDF_SCHEME_Marshal((TPMU_KDF_SCHEME *)&(source->details),
                                                       buffer,
                                                       size,
                                                       (UINT32)source->scheme));
    return result;
...
{
    UINT16 result = 0;
    result = (UINT16)(result + TPMI_ALG_RSA_SCHEME_Marshal(
                                   (TPMI_ALG_RSA_SCHEME *)&(source->scheme), buffer, size));
    result =
        (UINT16)(result + TPMU_ASYM_SCHEME_Marshal((TPMU_ASYM_SCHEME *)&(source->details),
                                                   buffer,
                                                   size,
                                                   (UINT32)source->scheme));
    return result;
...
{
    UINT16 result = 0;
    result = (UINT16)(result + TPMI_ALG_RSA_DECRYPT_Marshal(
...
{
    UINT16 result = 0;
    result = (UINT16)(result + TPM2B_ECC_PARAMETER_Marshal(
...
TPM2B_ECC_POINT_Marshal(TPM2B_ECC_POINT *source, BYTE **buffer, INT32 *size)
{
    ...
    result = (UINT16)(result + TPMS_ECC_POINT_Marshal(
...
{
    UINT16 result = 0;
    result = (UINT16)(result + TPMI_ALG_ECC_SCHEME_Marshal(
...
TPMS_SIGNATURE_RSA_Marshal(TPMS_SIGNATURE_RSA *source, BYTE **buffer, INT32 *size)
{
    ...
    result = (UINT16)(result + TPMI_ALG_HASH_Marshal(
                                   (TPMI_ALG_HASH *)&(source->hash), buffer, size));
    result = (UINT16)(result + TPM2B_PUBLIC_KEY_RSA_Marshal(
...
TPMT_SIGNATURE_Marshal(TPMT_SIGNATURE *source, BYTE **buffer, INT32 *size)
{
    ...
    result = (UINT16)(result + TPMU_SIGNATURE_Marshal((TPMU_SIGNATURE *)&(source->signature),
                                                      buffer,
                                                      size,
    ...
    TPM2B_ENCRYPTED_SECRET *source, BYTE **buffer, INT32 *size)
{
    ...
    if (source->t.size == 0)
        return result;
    result = (UINT16)(result + BYTE_Array_Marshal((BYTE *)&(source->t.secret),
                                                  buffer,
                                                  size,
                                                  (INT32)source->t.size));
    return result;
...
{
    UINT16 result = 0;
    result = (UINT16)(result + TPMT_KEYEDHASH_SCHEME_Marshal(
...
TPMS_RSA_PARMS_Marshal(TPMS_RSA_PARMS *source, BYTE **buffer, INT32 *size)
{
    ...
    result = (UINT16)(result + TPMT_RSA_SCHEME_Marshal(
                                   (TPMT_RSA_SCHEME *)&(source->scheme), buffer, size));
    result = (UINT16)(result + TPMI_RSA_KEY_BITS_Marshal(
...
TPMS_ECC_PARMS_Marshal(TPMS_ECC_PARMS *source, BYTE **buffer, INT32 *size)
{
    ...
    result = (UINT16)(result + TPMI_ECC_CURVE_Marshal(
...
TPMT_PUBLIC_Marshal(TPMT_PUBLIC *source, BYTE **buffer, INT32 *size)
{
    ...
    result = (UINT16)(result + TPMU_PUBLIC_PARMS_Marshal(
                                   ...
                                   size,
                                   (UINT32)source->type));
    result = (UINT16)(result + TPMU_PUBLIC_ID_Marshal((TPMU_PUBLIC_ID *)&(source->unique),
                                                      buffer,
                                                      size,
                                                      (UINT32)source->type));
    return result;
...
TPM2B_PUBLIC_Marshal(TPM2B_PUBLIC *source, BYTE **buffer, INT32 *size)
{
    ...
    result = UINT16_Marshal(&result, buffer, size);
    // Marshal the structure
    result = (UINT16)(result + TPMT_PUBLIC_Marshal(
...
TPMT_SENSITIVE_Marshal(TPMT_SENSITIVE *source, BYTE **buffer, INT32 *size)
{
    ...
    result = (UINT16)(result + TPM2B_AUTH_Marshal(
                                   (TPM2B_AUTH *)&(source->authValue), buffer, size));
    result = (UINT16)(result + TPM2B_DIGEST_Marshal(
                                   (TPM2B_DIGEST *)&(source->seedValue), buffer, size));
    result = (UINT16)(result + TPMU_SENSITIVE_COMPOSITE_Marshal(
...
TPM2B_SENSITIVE_Marshal(TPM2B_SENSITIVE *source, BYTE **buffer, INT32 *size)
{
    ...
    result = UINT16_Marshal(&result, buffer, size);
    // Marshal the structure
    result = (UINT16)(result + TPMT_SENSITIVE_Marshal(
...
TPM2B_ID_OBJECT_Marshal(TPM2B_ID_OBJECT *source, BYTE **buffer, INT32 *size)
{
    ...
    if (source->t.size == 0)
        return result;
    result = (UINT16)(result + BYTE_Array_Marshal((BYTE *)&(source->t.credential),
                                                  buffer,
                                                  size,
                                                  (INT32)source->t.size));
    return result;
...
TPMS_NV_PUBLIC_Marshal(TPMS_NV_PUBLIC *source, BYTE **buffer, INT32 *size)
{
    UINT16 result = 0;
    result =
        (UINT16)(result + TPMI_RH_NV_LEGACY_INDEX_Marshal(
                              (TPMI_RH_NV_LEGACY_INDEX *)&(source->nvIndex), buffer, size));
    result = (UINT16)(result + TPMI_ALG_HASH_Marshal(
                                   (TPMI_ALG_HASH *)&(source->nameAlg), buffer, size));
    result =
        (UINT16)(result + TPMA_NV_Marshal((TPMA_NV *)&(source->attributes), buffer, size));
    result = (UINT16)(result + TPM2B_DIGEST_Marshal(
                                   (TPM2B_DIGEST *)&(source->authPolicy), buffer, size));
    result =
...
TPM2B_NV_PUBLIC_Marshal(TPM2B_NV_PUBLIC *source, BYTE **buffer, INT32 *size)
{
    ...
    result = UINT16_Marshal(&result, buffer, size);
    // Marshal the structure
    result = (UINT16)(result + TPMS_NV_PUBLIC_Marshal(
...
{
    UINT16 result = 0;
    result = (UINT16)(result + TPMI_RH_NV_EXP_INDEX_Marshal(
                                   (TPMI_RH_NV_EXP_INDEX *)&(source->nvIndex), buffer, size));
    result = (UINT16)(result + TPMI_ALG_HASH_Marshal(
                                   (TPMI_ALG_HASH *)&(source->nameAlg), buffer, size));
    result = (UINT16)(result + TPMA_NV_EXP_Marshal(
...
{
    UINT16 result = 0;
    result = (UINT16)(result + TPM_HT_Marshal((TPM_HT *)&(source->handleType), buffer, size));
    result =
        (UINT16)(result + TPMU_NV_PUBLIC_2_Marshal((TPMU_NV_PUBLIC_2 *)&(source->nvPublic2),
                                                   buffer,
                                                   size,
...
TPM2B_NV_PUBLIC_2_Marshal(TPM2B_NV_PUBLIC_2 *source, BYTE **buffer, INT32 *size)
{
    ...
    result = UINT16_Marshal(&result, buffer, size);
    // Marshal the structure
    result = (UINT16)(result + TPMT_NV_PUBLIC_2_Marshal(
...
TPMS_CONTEXT_DATA_Marshal(TPMS_CONTEXT_DATA *source, BYTE **buffer, INT32 *size)
{
    ...
    result =
        (UINT16)(result + TPM2B_CONTEXT_SENSITIVE_Marshal(
...
TPMS_CONTEXT_Marshal(TPMS_CONTEXT *source, BYTE **buffer, INT32 *size)
{
    ...
    result = (UINT16)(result + TPMI_DH_SAVED_Marshal(
                                   (TPMI_DH_SAVED *)&(source->savedHandle), buffer, size));
    result = (UINT16)(result + TPMI_RH_HIERARCHY_Marshal(
                                   (TPMI_RH_HIERARCHY *)&(source->hierarchy), buffer, size));
    result = (UINT16)(result + TPM2B_CONTEXT_DATA_Marshal(
...
TPMS_CREATION_DATA_Marshal(TPMS_CREATION_DATA *source, BYTE **buffer, INT32 *size)
{
    ...
    result = (UINT16)(result + TPM2B_DIGEST_Marshal(
                                   (TPM2B_DIGEST *)&(source->pcrDigest), buffer, size));
    result = (UINT16)(result + TPMA_LOCALITY_Marshal(
...
TPM2B_CREATION_DATA_Marshal(TPM2B_CREATION_DATA *source, BYTE **buffer, INT32 *size)
{
    ...
    // Marshal the structure
    result =
        (UINT16)(result + TPMS_CREATION_DATA_Marshal(
...
TPML_AC_CAPABILITIES_Marshal(TPML_AC_CAPABILITIES *source, BYTE **buffer, INT32 *size)
{
    ...
    result =
        (UINT16)(result + UINT32_Marshal((UINT32 *)&(source->count), buffer, size));
    result = (UINT16)(result + TPMS_AC_OUTPUT_Array_Marshal(
