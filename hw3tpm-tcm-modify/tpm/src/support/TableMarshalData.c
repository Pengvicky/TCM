...
MarshalData_st MarshalData = {
    ...
    {MIN_MAX_MTYPE,
     ...
     {TPM_ECC_NONE,
      RANGE(1, 32, UINT16),
      (UINT32)((ECC_NIST_P192 << 0) | (ECC_NIST_P224 << 1) | (ECC_NIST_P256 << 2) | (ECC_NIST_P384 << 3) | (ECC_NIST_P521 << 4) | (ECC_BN_P256 << 15) | (ECC_BN_P638 << 16) | (ECC_SM2_P256 << 31))}},
    ...
    {MIN_MAX_MTYPE,
     ...
     {TPM_ALG_NULL,
      RANGE(4, 41, UINT16),
      (UINT32)((ALG_SHA1 << 0) | (ALG_SHA256 << 7) | (ALG_SHA384 << 8) | (ALG_SHA512 << 9) | (ALG_SM3_256 << 14)),
    ...
    {MIN_MAX_MTYPE,
     ...
     {TPM_ALG_NULL,
      RANGE(63, 68, UINT16),
      (UINT32)((ALG_CMAC << 0) | (ALG_CTR << 1) | (ALG_OFB << 2) | (ALG_CBC << 3) | (ALG_CFB << 4) | (ALG_ECB << 5))}},
    // TPMI_ALG_KDF_DATA
    {MIN_MAX_MTYPE,
     TWO_BYTES | TAKES_NULL | HAS_BITS,
     (UINT8)TPM_RC_KDF,
     {TPM_ALG_NULL,
      RANGE(7, 34, UINT16),
      (UINT32)((ALG_MGF1 << 0) | (ALG_KDF1_SP800_56A << 25) | (ALG_KDF2 << 26) | (ALG_KDF1_SP800_108 << 27))}},
    ...
    {MIN_MAX_MTYPE,
     ...
     {TPM_ALG_NULL,
      RANGE(5, 28, UINT16),
      (UINT32)((ALG_HMAC << 0) | (ALG_RSASSA << 15) | (ALG_RSAPSS << 17) | (ALG_ECDSA << 19) | (ALG_ECDAA << 21) | (ALG_SM2 << 22) | (ALG_ECSCHNORR << 23))}},
    ...
    {MIN_MAX_MTYPE,
     ...
     {TPM_ALG_NULL,
      RANGE(4, 63, UINT16),
      (UINT32)((ALG_SHA1 << 0) | (ALG_SHA256 << 7) | (ALG_SHA384 << 8) | (ALG_SHA512 << 9) | (ALG_SM3_256 << 14)),
      (UINT32)((ALG_SHA3_256 << 3) | (ALG_SHA3_384 << 4) | (ALG_SHA3_512 << 5) | (ALG_CMAC << 27))}},
    ...
    {MIN_MAX_MTYPE,
     ...
     {TPM_ALG_NULL,
      RANGE(64, 68, UINT16),
      (UINT32)((ALG_CTR << 0) | (ALG_OFB << 1) | (ALG_CBC << 2) | (ALG_CFB << 3) | (ALG_ECB << 4))}},
    // TPMS_EMPTY_DATA
    ...
    {MIN_MAX_MTYPE,
     ...
     {TPM_ALG_NULL,
      RANGE(20, 29, UINT16),
      (UINT32)((ALG_RSASSA << 0) | (ALG_RSAES << 1) | (ALG_RSAPSS << 2) | (ALG_OAEP << 3) | (ALG_ECDSA << 4) | (ALG_ECDH << 5) | (ALG_ECDAA << 6) | (ALG_SM2 << 7) | (ALG_ECSCHNORR << 8) | (ALG_ECMQV << 9))}},
    ...
    {MIN_MAX_MTYPE,
     ...
     {TPM_ALG_NULL,
      RANGE(24, 29, UINT16),
      (UINT32)((ALG_ECDSA << 0) | (ALG_ECDH << 1) | (ALG_ECDAA << 2) | (ALG_SM2 << 3) | (ALG_ECSCHNORR << 4) | (ALG_ECMQV << 5))}},
    // TPMI_ECC_CURVE_DATA
    {MIN_MAX_MTYPE,
     TWO_BYTES | TAKES_NULL | HAS_BITS,
     (UINT8)TPM_RC_CURVE,
