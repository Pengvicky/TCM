...
#  if ALG_SM2
    case TPM_ALG_SM2:
        return auth->signature.sm2.hash;
#  endif
#  if ALG_ECSCHNORR
    case TPM_ALG_ECSCHNORR:
        return auth->signature.ecschnorr.hash;
#  endif
#  if ALG_EDDSA
    case TPM_ALG_EDDSA:
        return auth->signature.eddsa.hash;
#  endif
#  if ALG_EDDSA_PH
    case TPM_ALG_EDDSA_PH:
        return auth->signature.eddsa_ph.hash;
#  endif
#  if ALG_ECDAA
    case TPM_ALG_ECDAA:
        break;
