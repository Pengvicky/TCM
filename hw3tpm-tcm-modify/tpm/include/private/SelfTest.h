...
//这个文件是自测试框架的基础，用于在TPM启动或需要时执行密码算法的自检。
...
#endif
//这个结构体包含了对称加密算法的测试向量，包括算法类型、密钥大小、测试密钥、初始化向量大小、输入数据、以及不同模式下的预期输出数据。
...
#elif ALG_SM3_256
#  define DEFAULT_TEST_HASH            ALG_SM3_256_VALUE
#  define DEFAULT_TEST_DIGEST_SIZE     SM3_256_DIGEST_SIZE
#  define DEFAULT_TEST_HASH_BLOCK_SIZE SM3_256_BLOCK_SIZE
#endif
#endif // _SELF_TEST_H_