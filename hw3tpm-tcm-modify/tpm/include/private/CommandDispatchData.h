...
CreatePrimary_COMMAND_DESCRIPTOR_t _CreatePrimaryData = {
    ...
    (UINT16)(offsetof(CreatePrimary_Out,
   creationTicket)),
...
HierarchyControl_COMMAND_DESCRIPTOR_t _HierarchyControlData = {
    ...
    /* outSize */ 0,
    /* offsetOfTypes */ offsetof(HierarchyControl_COMMAND_DESCRIPTOR_t,
   types),
...
NV_Read_COMMAND_DESCRIPTOR_t _NV_ReadData = {
    ...
    &TPM2_NV_Read,
    /* inSize */ 
    (UINT16)(sizeof(NV_Read_In)),
    /* outSize */ 
    (UINT16)(sizeof(NV_Read_Out)),
    /* offsetOfTypes */ 
    offsetof(NV_Read_COMMAND_DESCRIPTOR_t, types),
    /* offsets */ 
